...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import CUTENSOR_CUDA102_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3383e110-d2c8-5588-847f-51a846eee08b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "CUTENSOR_CUDA102", artifacts_toml) for e in artifacts["CUTENSOR_CUDA102"]]
...
if best_platform === nothing
    @debug("Unable to load CUTENSOR_CUDA102; unsupported platform $(triplet(platform_key_abi()))")
else
